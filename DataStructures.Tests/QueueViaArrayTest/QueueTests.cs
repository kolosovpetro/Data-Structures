...
namespace DataStructures.Tests.QueueViaArrayTest
{
    [TestFixture]
    public class QueueTests
    {
        ...
        {
            IQueue<string> queue = new QueueViaArray.Implementations.Queue<string>(10);
        ...
        {
            IQueue<string> queue = new QueueViaArray.Implementations.Queue<string>(3);
            queue.Enqueue("A");
            queue.Enqueue("B");
            queue.Enqueue("C");
